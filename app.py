...
def load_and_process_data():
    ...
    """
    # Nome exato da sua base de dados no repositório
    file_path = "BASE DE DADOS PEDE 2024 - DATATHON.xlsx"

    try:
        xls = pd.ExcelFile(file_path)
    except Exception as e:
        st.error(f"Erro ao carregar o arquivo '{file_path}'. Verifique se o arquivo com a extensão .xlsx foi enviado para a raiz do repositório no GitHub.")
        st.stop()
