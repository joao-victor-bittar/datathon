...
def load_and_process_data():
    """
    Carrega o arquivo localizado dentro da pasta /data no repositório,
    ...
    try:
        ...
        st.error(f"Erro ao carregar o arquivo '{file_path}'. Verifique se a pasta 'data' e o arquivo Excel (.xlsx) estão no repositório no GitHub.")
        st.stop()
